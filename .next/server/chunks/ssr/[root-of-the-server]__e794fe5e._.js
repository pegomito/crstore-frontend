...
"[project]/src/app/tasksUser/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function TasksUsuario() {
    ...
    const buscarUsuario = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/users");
    ...
    const criarUsuario = async (formValues)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/users", {
    ...
    const editarUsuario = async (task)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/users/${task.id}`, {
                name: task.name,
                cpf: task.cpf,
    ...
    const excluirUsuario = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/users/${id}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e794fe5e._.js.map