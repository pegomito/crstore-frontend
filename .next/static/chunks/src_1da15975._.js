...
"[project]/src/app/tasksSala/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function TasksUsuario() {
    ...
    const buscarUsuario = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/salas');
    ...
    const criarTask = async (formValues)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/salas', {
    ...
    const editarUsuario = async (task)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`/salas/${task.id}`, {
    ...
    const excluirUsuario = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/salas/${id}`);
...
_s(TasksUsuario, "y+7uukHaD4wPY3MFvuRJ24v3cq4=");
_c = TasksUsuario;
var _c;
...
//# sourceMappingURL=src_1da15975._.js.map