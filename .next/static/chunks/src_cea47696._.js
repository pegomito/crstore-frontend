...
"[project]/src/app/tasksCargo/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function TasksCargo() {
    ...
    const buscarCargo = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/cargos');
            setTasks(response.data.data);
        } catch (error) {}
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TasksCargo.useEffect": ()=>{
            buscarCargo();
        }
    }["TasksCargo.useEffect"], []);
    ...
    const criarTask = async (formValues)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/cargos', {
    ...
    const editarCargo = async (task)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`/cargos/${task.id}`, {
    ...
    const excluirCargo = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/cargos/${id}`);
...
_s(TasksCargo, "y+7uukHaD4wPY3MFvuRJ24v3cq4=");
_c = TasksCargo;
var _c;
__turbopack_context__.k.register(_c, "TasksCargo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_cea47696._.js.map